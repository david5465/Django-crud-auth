...
def tasks(request):
    ...
    tasks = Task.objects.filter(user=request.user, datecompleted__isnull=True) #todas las tareas pendientes
    #tasks = Task.objects.all() todas las tareas de todos los usuarios
